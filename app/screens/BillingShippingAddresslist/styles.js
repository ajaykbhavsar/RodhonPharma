...
const styles = StyleSheet.create({
  ...
  defaultBadge:{
    backgroundColor:'#cfcfcf', width:70, textAlign:'center', borderRadius:viewportWidth*0.01,
  marginBottom:viewportWidth*0.03, fontFamily:Typography.FONT_POPPINS_REGULAR, fontSize:viewportWidth*0.03,
  borderWidth:1, borderColor:'#bdbdbd', paddingTop:viewportWidth*0.01
  },
  btnSetasDefault:{
    width:120, backgroundColor:'#F9CACA', borderWidth:1, borderColor:'#800000', marginBottom:viewportWidth*0.03,
    paddingHorizontal:viewportWidth*0.03, paddingVertical:viewportWidth*0.005, borderRadius:viewportWidth*0.01, zIndex:9999,
  },
  defaultBadgeText:{
    width:'100%', textAlign:'center', fontFamily:Typography.FONT_POPPINS_REGULAR, fontSize:viewportWidth*0.03,
