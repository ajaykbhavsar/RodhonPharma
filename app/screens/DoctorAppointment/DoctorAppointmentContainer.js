...
class DoctorAppointmentContainer extends Component {
  constructor(props) {
    super(props);
  }
  ...
  async onFocusFunction() {
    ...
    // const { loadDoctorAppointmentbanners  } = this.props;
    // loadDoctorAppointmentbanners();
    // loadLatestevents();
    // loadUpcomingevents();
  }
  ...
  render() {
    return <DoctorAppointmentView {...this.props} />;
  }
}
...
function mapStateToProps(state) {
  return {
    ...
    isDoctortype: state.loginReducer.IsDoctor
