...
import PrescriptionDetailsView from './PrescriptionDetailsView';
...
class PrescriptionDetailsContainer extends Component {
    ...
    async onFocusFunction () {
      ...
      const { loadPrescriptionDetailsbanners  } = this.props;
      loadPrescriptionDetailsbanners();
      loadLatestevents();
      loadUpcomingevents();
    }
  ...
  render() {
      return <PrescriptionDetailsView {...this.props} />;        
  }
}
